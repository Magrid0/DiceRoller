...
public class Roller {
    ...
    public static void d6 () {
        ...
        System.out.println("Random number within the range(1-6): " + randomNumber); // Print the number.
    ...
    public static void d8 () {
        ...
        System.out.println("Random number within the range(1-8): " + randomNumber); // Print the number.
    ...
    public static void d10 () {
        ...
        System.out.println("Random number within the range(1-10): " + randomNumber); // Print the number.
    ...
    public static void d12 () {
        ...
        System.out.println("Random number within the range(1-12): " + randomNumber); // Print the number.
    ...
    public static void d20 () {
        ...
        System.out.println("Random number within the range(1-20): " + randomNumber); // Print the number.
    ...
    public static void d30 () {
        ...
        System.out.println("Random number within the range(1-30): " + randomNumber); // Print the number.
